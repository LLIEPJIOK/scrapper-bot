...
const (
	...
	trackAddSetTime            fsm.State = "track_add_set_time"
	trackAddSetTimeImmediately fsm.State = "track_add_set_time_immediately"
	trackAddSetTimeDigest      fsm.State = "track_add_set_time_digest"

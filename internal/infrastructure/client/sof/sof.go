...
func (s *SOF) GetUpdates(link string, from, to time.Time) ([]string, error) {
	...
	msgs = append(msgs, s.answersToMessages(answers, title, link)...)
	msgs = append(msgs, s.commentsToMessages(answersCommens, title, link)...)
	msgs = append(msgs, s.commentsToMessages(comments, title, link)...)
...
func (s *SOF) answersToMessages(answers []Answer, questionTitle, questionLink string) []string {
...
func (s *SOF) commentsToMessages(comment []Comment, questionTitle, questionLink string) []string {

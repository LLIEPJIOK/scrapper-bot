...
func (s *Service) RegisterChat(ctx context.Context, id int64) error {
...
func (s *Service) AddLink(ctx context.Context, link *domain.Link) error {
...
func (s *Service) DeleteLink(ctx context.Context, link *domain.Link) error {
...
func (s *Service) GetLinks(ctx context.Context, chatID int64) ([]*domain.Link, error) {
